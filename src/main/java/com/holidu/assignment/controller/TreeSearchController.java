...
public class TreeSearchController {
    ...
    @Autowired
    TreeSearchServiceImpl treeSearchService;
    ...
    public ResponseEntity<TreeSearchResponse> findTreeSpecies(@RequestBody String requestBody) {
        return treeSearchService.findTreeSpecies();
    }
